   ...
   return (
      ...
      >
         <div className="inline-flex justify-end">
            <label htmlFor="line" className="flex self-center">{i18n.Line}:</label>
         ...
         <div className="inline-flex justify-end">
            <label htmlFor="node" className="flex self-center">{i18n.Node}:</label>
            <select id="node"
         ...
         <div className="inline-flex justify-end">
            <label htmlFor="name" className="flex self-center">{i18n.Name}:</label>
         ...
         <div className="inline-flex justify-end">
            <label htmlFor="ip" className="flex self-center">{i18n.Ip}:</label>
         ...
         <div className="inline-flex justify-end">
            <label htmlFor="type" className="self-center">{i18n.Type}:</label>
            <select id="type"
               ...
               <option key='' value=''>{i18n.Select}</option>
               <option key='siemens' value='siemens'>{i18n.Siemens}</option>
               <option key='modbus' value='modbus'>{i18n.Modbus}</option>
               <option key='omron' value='omron'>{i18n.Omron}</option>
            </select>
         </div>
         {errors.type && <p role="alert" className="text-red self-end">⚠ {errors.type?.message}</p>}

         <div className="inline-flex justify-around">
            <input type="reset" onClick={() => { clearErrors() }} className={'my-1 py-2 px-5 rounded-md text-textColor font-bold border border-accent bg-bgDark'} value={i18n.Clear} />
            <input className={'my-1 py-2 px-5 rounded-md text-textColor font-bold border border-accent bg-accent'} type="submit" value={i18n.Send} />
         </div>
      </form >
   );
};