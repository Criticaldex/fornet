...
function getBaseNodesConfig(dbName: string) {
   return [
      {
         "id": "e48de9f0bc1f4a1a",
...
function globalSiemensNodes(plc: any, sensorByName: any, nodes: any[]): void {
   let vartables: any = [];
...
function globalModbusNodes(plc: any, nodes: any[]): void {
...
function globalOmronNodes(plc: any, nodes: any[]): void {
   const FinsConn: any = {
      "id": plc._id.toString(),
...
function nodeWriteSiemens(sensor: any, plc: any, y: number, nodes: any[]) {
   const s7out: any = {
...
function nodeWriteModbus(sensor: any, plc: any, y: number, nodes: any[]) {
